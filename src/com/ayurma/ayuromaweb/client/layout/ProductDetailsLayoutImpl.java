...
public class ProductDetailsLayoutImpl extends ArrayList<ProductDetailsLayout<ProductDetails>>{
	private String imageServletUrl;
	@Inject
	public ProductDetailsLayoutImpl(@Named("imageServletUrl") String imageServletUrl0){
		...
		add(new ProductDetailsLayout<ProductDetails>(){
			...
			public void render(ProductDetails t, StringBuilder sb,Map<String,String> styles) {
				...
				String str=	"<table  style='font-family:arial;'>"
				...
				str+="<tr style='"+rowStyles[iStyle]+"'><td class='"+styles.get("valueName")+"'>Common Name </td><td  class='"+styles.get("value")+"'>"+t.getCommonName()+"</td></tr>";
				iStyle=(iStyle>0)?0:1;
				}
				//1 bot name:
				if(listDisplay[1]==1){
					 str+="<tr style='"+rowStyles[iStyle]+"'><td class='"+styles.get("valueName")+"'>Botanical Name: </td><td  class='"+styles.get("value")+"' style='font-style:italic;'>"+t.getBotanicalName()+"</td></tr>";
					 iStyle=(iStyle>0)?0:1;
				}
				//2 country of origin
				if(listDisplay[2]==1){
				str+="<tr style='"+rowStyles[iStyle]+"'><td class='"+styles.get("valueName")+"'>Country of Origin: </td><td  class='"+styles.get("value")+"'>"+t.getCountryOfOrigin()+"</td></tr>";
				iStyle=(iStyle>0)?0:1;
				}
				//3 chemical constituents
				if(listDisplay[3]==1){
				str+="<tr style='"+rowStyles[iStyle]+"'><td class='"+styles.get("valueName")+"'>Major Chemical constituents:</td><td  class='"+styles.get("value")+"'>"+t.getChemicalConstituent()+"</td></tr>";
				iStyle=(iStyle>0)?0:1;
				}
				//4 source
				if(listDisplay[4]==1){
				str+="<tr style='"+rowStyles[iStyle]+"'><td class='"+styles.get("valueName")+"'>Obtained from:</td><td  class='"+styles.get("value")+"'>"+t.getPlantPart()+"</td></tr>";
				iStyle=(iStyle>0)?0:1;
				}
				//5 separation method
				if(listDisplay[5]==1){
				str+="<tr style='"+rowStyles[iStyle]+"'><td class='"+styles.get("valueName")+"'>Method of separation:</td><td  class='"+styles.get("value")+"'>"+t.getSaparationMethod()+"</td></tr>";
				iStyle=(iStyle>0)?0:1;
				}
				//6 color and appearance
				if(listDisplay[6]==1){
				str+="<tr style='"+rowStyles[iStyle]+"'><td class='"+styles.get("valueName")+"'>Color and appearance:</td><td class='"+styles.get("value")+"'>"+t.getColorAndAppearance()+"</td></tr>";
				iStyle=(iStyle>0)?0:1;
				}
				//7 order and smell
				if(listDisplay[7]==1){
				str+="<tr style='"+rowStyles[iStyle]+"'><td class='"+styles.get("valueName")+"'>Order </td><td  class='"+styles.get("value")+"'>"+t.getOrder()+"</td></tr>";
				iStyle=(iStyle>0)?0:1;
				}
				//8 solubility
				if(listDisplay[8]==1){
				str+="<tr style='"+rowStyles[iStyle]+"'><td class='"+styles.get("valueName")+"'>Solubility</td><td  class='"+styles.get("value")+"'>"+t.getSolubility()+"</td></tr>";;
				iStyle=(iStyle>0)?0:1;
				}
		...
		add(new ProductDetailsLayout<ProductDetails>(){
			...
			public void render(ProductDetails t, StringBuilder sb,Map<String,String> styles) {
				if(t.getIsSection2Displayed()==1){
					...
					str+="<table style='font-family:arial;'>"
					...
					if(t.getIsRfrIndexDspl()==1){
						...
						str+="<tr style='"+rowStyles[iStyle]+"'><td class='"+styles.get("valueName")+"'>Refractive Index at "+t.getTempRefracIndex();
					...
					if(t.getIsOptRotDspl()==1){
						str+="<tr style='"+rowStyles[iStyle]+"'><td class='"+styles.get("valueName")+"'>Optical Rotation</td><td  class='value'>";
				...
				str+="<tr style='"+rowStyles[iStyle]+"'><td class='"+styles.get("valueName")+"'>Specific Gravity at "+t.getTempSpGrav();
				...
				str+="<tr style='"+rowStyles[iStyle]+"'><td class='"+styles.get("valueName")+"'>Flash Point (";
